            ...
            >
              ...
              >
                <div className="py-2">
                  ...
                  <a href="/jp" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 bg-blue-50">
                    <span className="text-lg mr-3">🇯🇵</span>
                    <span className="font-medium text-blue-600">日本語</span>
                  </a>
          ...
          <div className="space-y-1">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobileLanguageOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="pl-4 space-y-1">
                ...
                <a href="/jp" className="flex items-center text-blue-600 bg-blue-50 block px-3 py-2 rounded-md text-sm font-medium">
                  <span className="text-lg mr-3">🇯🇵</span>
                  日本語
                </a>
