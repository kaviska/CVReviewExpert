        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up">
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Verificador de Currículo ATS</span> Gratuito & Revisão de CV
            </h1>
            <p className="text-xl text-gray-600 mb-8 animate-fade-in-up animation-delay-200">
              Carregue o seu CV ou currículo para receber uma verificação instantânea. Verifique a compatibilidade ATS, corrija palavras-chave e obtenha dicas comprovadas do nosso serviço de revisão de currículo com IA para fazer os recrutadores dizerem "sim".
            </p>
              ...
              <a href="/pt/cv-review">
                <button className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 text-white px-12 py-5 rounded-2xl text-lg font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 shadow-xl overflow-hidden group">
                  ...
                  <span className="relative flex items-center justify-center">
                    ...
                    Iniciar Verificação CV Gratuita
                  </span>
                </button>
              </a>
              <p className="text-sm text-gray-500 mt-3">
                Análise gratuita • Sem registo • Resultados em 60 segundos
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-up animation-delay-600">
            <div className="relative">
              ...
              <div className="bg-white rounded-lg shadow-2xl p-8 w-80 h-96 relative transform rotate-3 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="absolute top-10 -left-3 bg-blue-500 rounded-full p-2 animate-pulse">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <div className="absolute bottom-4 -right-4 bg-purple-500 rounded-full p-2 animate-ping">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-lg shadow-lg p-4 animate-float">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Pontuação ATS (estimada)</div>
                </div>
              </div>
            </div>
          </div>
