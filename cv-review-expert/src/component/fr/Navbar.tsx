    ...
    <nav className="bg-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <a href="/fr" className="flex-shrink-0 flex items-center py-3">
              <img
                src="/logo.png"
                alt="AUCAL Logo"
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-6">
              <a href="/fr" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                Accueil
              </a>
                ...
                >
                  <div className="py-2">
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Révision de CV</div>
                        <div className="text-xs text-gray-500">Analyse gratuite de CV</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Analyse ATS</div>
                        <div className="text-xs text-gray-500">Scan et vérification</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Rédaction de CV</div>
                        <div className="text-xs text-gray-500">Création professionnelle</div>
                      </div>
                    </a>
                  </div>
                </div>
            ...
            >
              ...
              >
                <div className="py-2">
                  ...
                  >
                    <span className="text-lg mr-3">🇫🇷</span>
                    <span className="font-medium text-blue-600">Français</span>
                  </a>
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
          <a href="/fr" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            Accueil
          </a>
          ...
          <div className="space-y-1">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobileLanguageOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="pl-4 space-y-1">
                ...
                <a href="/fr" className="flex items-center text-blue-600 bg-blue-50 block px-3 py-2 rounded-md text-sm font-medium">
                  <span className="text-lg mr-3">🇫🇷</span>
                  Français
                </a>
          ...
          <div className="pt-4">
            ...
            >
              Commencer l'Analyse CV Gratuite
            </a>
          </div>
        </div>
      </div>
