  ...
  const features = [
    {
      ...
      title: "ATS互換性チェック",
      description: "CVや履歴書が応募者追跡システムを通過することを確認してください。ATSスコアを向上させ、自動却下を避けるための実用的なヒントを得られます。",
    ...
    },
    {
      ...
      title: "キーワード最適化",
      description: "求人の説明のキーワードを自動的にマッチさせます。当社のAIは、採用担当者とATSスキャナーが期待する不足している用語をハイライトします。",
    ...
    },
    {
      ...
      title: "CV & 履歴書フォーマットフィードバック",
      description: "レイアウト、フォント、間隔、階層に関するプロフェッショナルなヒントを得て、履歴書がきれいで読みやすく、採用担当者フレンドリーになるようにします。",
    ...
    },
    {
      ...
      title: "スキルギャップ分析",
      description: "不足しているスキルと資格を特定します。特定の役職に対してプロフィールを強化するための明確な推奨事項を取得してください。",
    ...
    },
    {
      ...
      title: "文法・言語チェック",
      description: "エラーを即座にキャッチし、高度な言語チェックでトーンを磨いて、自信に満ちたプロフェッショナルな仕上がりにします。",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            主要 <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">機能</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            当社のAIパワードプラットフォームは、面接を改善するために設計された完全なCVと履歴書スキャンを提供します—高速、手頃、そして実証済み。
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              CVや履歴書を改善する準備はできていますか？
            </h3>
            <p className="text-gray-600 mb-6">
              何千人もの人々に信頼されています。当社のAI履歴書チェッカーでCVを最適化し、今日から採用担当者に対応できるようになりましょう。
            </p>
            <a
              href="/jp/cv-review"
