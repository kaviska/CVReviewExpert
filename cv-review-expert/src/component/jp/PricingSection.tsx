      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-gray-900">
            すべての履歴書ツールが <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">完全無料</span>
          </h2>
          <p className="mt-4 text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            無制限のCV/履歴書分析、ATSチェック、キーワードインサイト、専門家ガイダンスをお楽しみください — ペイウォールなし、制限なし、価値のみ。
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="#how-it-works" className="text-blue-700 hover:text-blue-800 font-medium">使用方法を見る</a>
        </div>
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white/70 backdrop-blur rounded-2xl p-6 border border-green-100 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">無制限分析</h3>
            <p className="text-gray-600 text-sm">CV/履歴書チェックを好きなだけ実行できます。</p>
          </div>
          <div className="bg-white/70 backdrop-blur rounded-2xl p-6 border border-blue-100 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">完全プレミアム機能</h3>
            <p className="text-gray-600 text-sm">ATS最適化、キーワード、フォーマットヒント、PDFなど。</p>
          </div>
          <div className="bg-white/70 backdrop-blur rounded-2xl p-6 border border-purple-100 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">即座にアクセス</h3>
            <p className="text-gray-600 text-sm">サインアップの障壁なし — 数秒で開始できます。</p>
          </div>
        </div>

        {/* Soft reassurance */}
        <p className="mt-10 text-center text-sm text-gray-500">
          ご質問ですか？下のFAQをご覧いただくか、お問い合わせください — サポートいたします。
        </p>
      </div>
    </section>
  );
