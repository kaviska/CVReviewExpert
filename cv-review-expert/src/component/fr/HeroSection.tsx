        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up">
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Vérificateur CV ATS</span> Gratuit & Révision CV
            </h1>
            <p className="text-xl text-gray-600 mb-8 animate-fade-in-up animation-delay-200">
              Téléchargez votre CV ou curriculum vitae pour un scan instantané. Vérifiez la compatibilité ATS, corrigez les mots-clés, et obtenez des conseils éprouvés de notre service de révision CV alimenté par IA pour faire dire "OUI" aux recruteurs.
            </p>
              ...
              <a href="/fr/cv-review">
                <button className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 text-white px-12 py-5 rounded-2xl text-lg font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 shadow-xl overflow-hidden group">
                  ...
                  <span className="relative flex items-center justify-center">
                    ...
                    Commencer le Scan CV Gratuit
                  </span>
                </button>
              </a>
              <p className="text-sm text-gray-500 mt-3">
                Analyse gratuite • Aucune inscription • Résultats en 60 secondes
              </p>
            </div>
          </div>
