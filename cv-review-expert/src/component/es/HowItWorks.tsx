  ...
  const steps = [
    {
      ...
      title: "Subir CV",
      description: "Arrastra y suelta tu documento PDF o Word. Nuestro verificador de currículum seguro soporta todos los formatos principales y mantiene tus datos privados."
    },
    {
      number: "02",
      icon: (
      ...
      title: "Verificación CV con IA",
      description: "Nuestro verificador de currículum ATS analiza palabras clave, habilidades, formato y compatibilidad con sistemas de seguimiento de candidatos en segundos."
    },
    {
      number: "03",
      icon: (
      ...
      description: "Descarga un plan de acción claro con correcciones de palabras clave objetivo, ajustes de formato y recomendaciones de coincidencia de empleos para conseguir más entrevistas."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Cómo <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Funciona</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Obtén comentarios profesionales del CV en 3 pasos simples—optimizado para ATS y reclutadores reales.
          </p>
        </div>
