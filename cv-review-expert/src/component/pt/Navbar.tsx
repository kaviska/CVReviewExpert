    ...
    <nav className="bg-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <a href="/pt" className="flex-shrink-0 flex items-center py-3">
              <img
                src="/logo.png"
                alt="AUCAL Logo"
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-6">
              <a href="/pt" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                Início
              </a>
                ...
                >
                  <div className="py-2">
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Revisão de CV</div>
                        <div className="text-xs text-gray-500">Análise gratuita de currículo</div>
                      </div>
                    </a>

                    {/* ATS Analysis */}
                    <a 
                      href="/pt/ats-analysis" 
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Análise ATS</div>
                        <div className="text-xs text-gray-500">Verificação e análise</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Redação de CV</div>
                        <div className="text-xs text-gray-500">Criação profissional</div>
                      </div>
                    </a>
                  </div>
                </div>
              ...
              <a href="/pt/pricing" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                Preços
              </a>
              <a href="/pt/about" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                Sobre
              </a>
              <a href="/pt/contact" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                Contacto
              </a>
            </div>
          </div>
            ...
            >
              ...
              >
                <div className="py-2">
                  ...
                  <a href="/pt" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 bg-blue-50">
                    <span className="text-lg mr-3">🇵🇹</span>
                    <span className="font-medium text-blue-600">Português</span>
                  </a>
                  ...
                  <a href="/es" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200">
                    <span className="text-lg mr-3">🇪🇸</span>
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
          <a href="/pt" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            Início
          </a>
          ...
          <div>
            ...
            <div className={`pl-6 space-y-2 transition-all duration-300 ${isMobileServicesOpen ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0 overflow-hidden'}`}>
              <a href="/pt/cv-review" className="block px-3 py-2 text-sm text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200">
                Revisão de CV
              </a>
              <a href="/pt/ats-analysis" className="block px-3 py-2 text-sm text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200">
                Análise ATS
              </a>
              <a href="/pt/cv-writing" className="block px-3 py-2 text-sm text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200">
                Redação de CV
              </a>
            </div>
          </div>

          <a href="/pt/pricing" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            Preços
          </a>
          <a href="/pt/about" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            Sobre
          </a>
          <a href="/pt/contact" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            Contacto
          </a>
          ...
          <div className="space-y-1">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobileLanguageOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="pl-4 space-y-1">
                ...
                <a href="/pt" className="flex items-center text-blue-600 bg-blue-50 block px-3 py-2 rounded-md text-sm font-medium">
                  <span className="text-lg mr-3">🇵🇹</span>
                  Português
                </a>
                ...
                <a href="/es" className="flex items-center text-gray-600 hover:text-blue-600 block px-3 py-2 rounded-md text-sm font-medium">
                  <span className="text-lg mr-3">🇪🇸</span>
                  Español
                </a>
              </div>
