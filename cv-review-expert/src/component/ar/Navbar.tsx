    ...
    <nav className="bg-white shadow-lg sticky top-0 z-50" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <a href="/ar" className="flex-shrink-0 flex items-center py-3">
              <img
                src="/logo.png"
                alt="AUCAL Logo"
          ...
          <div className="hidden md:block">
            <div className="mr-10 flex items-baseline space-x-6 space-x-reverse">
              <a href="/ar" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                الرئيسية
              </a>
              ...
              >
                ...
                >
                  الخدمات
                  <svg 
                    className={`mr-1 h-4 w-4 transition-transform duration-200 ${isServicesOpen ? 'rotate-180' : ''}`}
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                {/* Dropdown Menu */}
                <div
                  className={`absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden transition-all duration-300 ease-out transform origin-top ${
                    isServicesOpen 
                ...
                >
                  <div className="py-2">
                    ...
                    >
                      <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center ml-3 group-hover:bg-blue-200 transition-colors duration-200">
                        <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                      <div>
                        <div className="font-medium">مراجعة السيرة الذاتية</div>
                        <div className="text-xs text-gray-500">تحليل مجاني للسيرة الذاتية</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">تحليل ATS</div>
                        <div className="text-xs text-gray-500">فحص وتحليل</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">كتابة السيرة الذاتية</div>
                        <div className="text-xs text-gray-500">إنشاء احترافي</div>
                      </div>
                    </a>
                  </div>
                </div>
          ...
          <div className="hidden md:flex items-center space-x-4 space-x-reverse">
            ...
            >
              ...
              >
                ...
                العربية
                <svg 
                  className={`mr-1 h-4 w-4 transition-transform duration-200 ${isLanguageOpen ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`absolute left-0 mt-2 w-48 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden transition-all duration-300 ease-out transform origin-top ${
                  isLanguageOpen 
                    ? 'opacity-100 scale-100 translate-y-0 visible' 
                    : 'opacity-0 scale-95 -translate-y-2 invisible'
                }`}
              ...
              >
                <div className="py-2">
                  ...
                  <a 
                    href="/" 
                    className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200"
                  >
                  ...
                  <a 
                    href="/ar" 
                    className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 bg-blue-50"
                  >
                    <span className="text-lg ml-3">🇸🇦</span>
                    <span className="font-medium text-blue-600">العربية</span>
                  </a>
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
          <a href="/ar" className="block px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md text-base font-medium transition-colors duration-200">
            الرئيسية
          </a>
          ...
          <div>
            ...
            <div className={`pr-6 space-y-2 transition-all duration-300 ${isMobileServicesOpen ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0 overflow-hidden'}`}>
          ...
          <div className="space-y-1">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobileLanguageOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="pr-4 space-y-1">
                ...
                <a href="/ar" className="flex items-center text-blue-600 bg-blue-50 block px-3 py-2 rounded-md text-sm font-medium">
                  <span className="text-lg ml-3">🇸🇦</span>
                  العربية
                </a>
          ...
          <div className="pt-4">
            ...
            >
              ابدأ تحليل السيرة الذاتية المجاني
            </a>
          </div>
        </div>
      </div>
