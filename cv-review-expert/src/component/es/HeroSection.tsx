        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up">
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Verificador de Currículum ATS</span> Gratuito & Revisión de CV
            </h1>
            <p className="text-xl text-gray-600 mb-8 animate-fade-in-up animation-delay-200">
              Sube tu CV o currículum para recibir una verificación instantánea. Verifica la compatibilidad ATS, corrige palabras clave y obtén consejos probados de nuestro servicio de revisión de currículum con IA para hacer que los reclutadores digan "sí".
            </p>
              ...
              <a href="/es/cv-review">
                <button className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 text-white px-12 py-5 rounded-2xl text-lg font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 shadow-xl overflow-hidden group">
                  ...
                  <span className="relative flex items-center justify-center">
                    ...
                    Iniciar Verificación CV Gratuita
                  </span>
                </button>
              </a>
              <p className="text-sm text-gray-500 mt-3">
                Análisis gratuito • Sin registro • Resultados en 60 segundos
              </p>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-lg shadow-lg p-4 animate-float">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Puntuación ATS (estimada)</div>
                </div>
              </div>
            </div>
          </div>
