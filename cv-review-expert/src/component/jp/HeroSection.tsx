        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up">
              無料 <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">ATS履歴書チェッカー</span> & CV レビュー
            </h1>
            <p className="text-xl text-gray-600 mb-8 animate-fade-in-up animation-delay-200">
              CVや履歴書をアップロードして即座に履歴書スキャンを受けましょう。ATS互換性をチェックし、キーワードを修正し、AIパワードの履歴書レビューサービスから実証済みのヒントを得て、採用担当者に「はい」と言わせましょう。
            </p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-lg shadow-lg p-4 animate-float">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">ATSスコア（推定）</div>
                </div>
              </div>
            </div>
          </div>
