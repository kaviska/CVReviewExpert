  ...
  const steps = [
    {
      ...
      title: "CVをアップロード",
      description: "PDFまたはWordドキュメントをドラッグ&ドロップしてください。当社の安全な履歴書チェッカーは主要なすべての形式をサポートし、あなたのデータを非公開に保ちます。"
    },
    {
      number: "02",
      icon: (
      ...
      title: "AI履歴書スキャン",
      description: "当社のATS履歴書チェッカーは、キーワード、スキル、フォーマット、応募者追跡システムの互換性を数秒で分析します。"
    },
    {
      number: "03",
      icon: (
      ...
      title: "レポートを取得",
      description: "対象キーワードの修正、フォーマットの調整、面接を増やすための求人マッチング推奨事項を含む明確なアクションプランをダウンロードしてください。"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            使用方法 <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">について</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            3つの簡単なステップでプロフェッショナルなCVフィードバックを取得—ATSと実際の採用担当者に最適化されています。
          </p>
        </div>
